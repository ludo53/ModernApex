...
#[derive(Debug)]
pub struct ModernApexProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ModernApexProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ModernApex processing");
    
    let mut processor = ModernApexProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ModernApexProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ModernApexProcessor::new(false);
